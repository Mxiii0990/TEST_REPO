...
public class Medico {
    ...
    @NotBlank(message = "El campo rut nbo puede estar vacio")
    @Pattern(regexp = "\\d{1,8}-[\\dKk]", message="El formato del rut titne que ser XXXXXXXXX-X")
    private String run;
    ...
    @NotNull (message = "El campo jefe no puede ser nulo")
